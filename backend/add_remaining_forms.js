...
async function addRemainingForms() {
  const memberId = 18;
  
  try {
    console.log(`🚀 Adding remaining forms for Cursur member ID: ${memberId}...`);
    
    // 1. Add to certification_details table
    await dbQuery(`
    ...
    console.log('🎉 Successfully completed ALL 6 forms for Cursur member!');
    ...
    console.error('❌ Error adding remaining forms:', error);
  } finally {
    db.end();
  }
}
